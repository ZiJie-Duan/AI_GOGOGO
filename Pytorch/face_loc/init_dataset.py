...
class BuildDataset:
    ...
    def wfd_random_cut(self, img, bboxs, type):
        ...
        if imgs_bboxs == []:
            imgn = img[bbox[1]:bbox[1]+bbox[3], bbox[0]:bbox[0]+bbox[2], :]
            imgs_bboxs.append((imgn, (0,0,bbox[2],bbox[3])))
        return imgs_bboxs
    ...
    def ceb_random_cut(self, img, bbox, landmark, num):
        ...
        if imgs_bboxs_landmark == []:
            imgn = img[bbox[1]:bbox[1]+bbox[3], bbox[0]:bbox[0]+bbox[2], :]
            imgs_bboxs_landmark.append((imgn, (0,0,bbox[2],bbox[3]), landmark))
